...
SECRET_KEY = 'django-insecure-8%7lxt_ds=_eltl)+p1xyk76g@4w2u5r4pgto*&fs0=!1c8iir'
...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://1c7b-188-190-190-33.ngrok-free.app']
...
# websocket
ASGI_APPLICATION = 'chat_bot_project.asgi.application'
CHANNEL_LAYERS = {
    "default": {
